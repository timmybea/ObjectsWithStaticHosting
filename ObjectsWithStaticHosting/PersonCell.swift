...
class PersonCell : UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        NSLayoutConstraint.activate([
            cachedImageView.leftAnchor.constraint(equalTo: leftAnchor),
            cachedImageView.topAnchor.constraint(equalTo: topAnchor),
            cachedImageView.bottomAnchor.constraint(equalTo: bottomAnchor),
            cachedImageView.widthAnchor.constraint(equalToConstant: frame.height)
            ])
    ...
    func setup(for person: Person) {
        ...
        self.cachedImageView.imageEndPoint = person.imageEndPoint        
    }
